...
const Sidebar = ({ isOpen, toggleSidebar }) => {
  ...
  return (
    <aside 
      className={`fixed inset-y-0 left-0 transform ${isOpen ? 'translate-x-0' : '-translate-x-full'} md:translate-x-0 transition duration-200 ease-in-out bg-white shadow-lg z-30 w-64 md:static`}
    >
      <div className="px-6 pt-6 pb-4 flex justify-between items-center md:hidden">
